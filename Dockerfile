...
CMD bash -c "python conveyervisionUI/manage.py makemigrations cv && python conveyervisionUI/manage.py migrate && python conveyervisionUI/manage.py runserver 0.0.0.0:8000"
